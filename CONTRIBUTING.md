...
```bash
dotnet build src/DNationalSystem.slnx
dotnet run --project src/Host/DNationalSystem.AppHost   # full Aspire stack
dotnet test src/DNationalSystem.slnx                    # tests (integration suite needs Docker)
```

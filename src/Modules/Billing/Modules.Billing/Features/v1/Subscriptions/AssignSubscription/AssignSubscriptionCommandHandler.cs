...
#pragma warning restore CA1308
        ...
        var plan = await dbContext.Plans
            .FirstOrDefaultAsync(p => p.Key == key && p.IsActive, cancellationToken)
        ...
        var current = await dbContext.Subscriptions
            .FirstOrDefaultAsync(
                s => s.TenantId == InstallationConstants.Id
        ...
        var subscription = Subscription.Create(InstallationConstants.Id, plan.Id, now);

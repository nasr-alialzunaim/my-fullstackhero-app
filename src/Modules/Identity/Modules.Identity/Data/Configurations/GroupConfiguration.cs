...
public class GroupConfiguration : IEntityTypeConfiguration<Group>
{
    public void Configure(EntityTypeBuilder<Group> builder)
    {
        ...
        builder.ToTable("Groups", IdentityModuleConstants.SchemaName);
        ...
        builder.Property(g => g.LastModifiedBy).HasColumnName("ModifiedBy").HasMaxLength(450);
        builder.Property(g => g.DeletedBy).HasMaxLength(450);
        builder.Property(g => g.CreatedOnUtc).HasColumnName("CreatedAt").HasDefaultValueSql("CURRENT_TIMESTAMP");
        builder.Property(g => g.LastModifiedOnUtc).HasColumnName("ModifiedAt");

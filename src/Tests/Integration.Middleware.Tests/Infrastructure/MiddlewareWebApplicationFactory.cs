...
public sealed class MiddlewareWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        // Migrate + seed the single installation; the semaphore stops test classes sharing a DB from
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            config.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["DatabaseOptions:MigrationsAssembly"] = "DNationalSystem.Migrations.PostgreSQL",

...
// Per-app prefix from the AppHost assembly name (DNationalSystem.AppHost -> fsh-starter); namespaces Docker volumes + resource names so multiple FSH apps don't clash.
...
var migrator = builder.AddProject<Projects.DNationalSystem_DbMigrator>($"{appPrefix}-db-migrator")
